        ...
        <CardContent className="grid p-0 md:grid-cols-2">
          ...
          >
            <FieldGroup className="gap-6">
              ...
              {/* Error message */}
              {error && (
                <div className="bg-red-50 border border-red-200 text-red-600 text-xs rounded-lg px-4 py-3 text-center font-medium">
                  {error}
                </div>
              )}
              ...
              <Field className="mt-2">
                <Button
                  type="submit"
                  disabled={loading}
                  className="w-full h-11 bg-[#E8450A] hover:bg-[#c73a08] text-white font-bold text-xs uppercase tracking-widest rounded-lg shadow-lg shadow-orange-900/25 hover:-translate-y-0.5 hover:shadow-xl transition-all duration-200 border-0 disabled:opacity-60 disabled:cursor-not-allowed disabled:translate-y-0"
                >
